...
export const darkCssVariables = {
  ...
  '--primary-default': '#ff766a',
  '--primary-hover': '#ff9a91',
  '--secondary-color': themeColors.dark.secondary,
  '--tertiary-color': '#ffc3bd',
  ...
  '--form-placeholder': 'rgba(163, 163, 163, 0.9)',
  '--form-focus-ring': '#ff766a',
  '--form-invalid-color': '#cc4b37',
...
export const lightCssVariables = {
  ...
  '--form-border-color': 'rgba(205, 205, 205, 0.4)',
  '--form-placeholder': 'color-mix(in srgb, rgb(82, 82, 82) 85%, transparent)',
  '--form-focus-ring': '#b73c34',
  '--form-invalid-color': '#d32f2f',
