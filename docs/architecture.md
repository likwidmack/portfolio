...
The site source lives in this repository: **Nuxt 4**, **SSR through Nitro**, TypeScript, Pug templates, and SCSS.
...
upstream GitHub Pages CI builds this repository. upstream promote workflow opens a squash PR after `development` CI passes.
