...
// Tracks which backend the list was last fetched for, so the composable's post-mount
...
const loadPosts = async () => {
  ...
  try {
    ...
    // request (network error, 500) doesn't block a later retry for the same database.
