...
.blog-editorial {
  ...
  &__card {
    ...
    &--feature .blog-editorial__feature-copy {
      display: grid;
    ...
    &--feature .blog-editorial__art {
      min-height: 8rem;
      background:
        repeating-linear-gradient(
          45deg,
          color-mix(in srgb, var(--primary-color) 12%, transparent) 0,
          color-mix(in srgb, var(--primary-color) 12%, transparent) 2px,
          transparent 2px,
          transparent 10px
        ),
        color-mix(in srgb, var(--primary-color) 6%, var(--surface-color));
    }
